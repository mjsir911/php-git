...
if test $PHP_GIT2 != "no"; then
	...
	PHP_ADD_SOURCES(src, repository_arginfo.h clone_arginfo.h oid_arginfo.h signature_arginfo.h commit_arginfo.h tree_arginfo.h revwalk_arginfo.h reference_arginfo.h reference_iterator_arginfo.h tag_arginfo.h revparse_arginfo.h)
	PHP_ADD_SOURCES_X(src, repository.c clone.c oid.c signature.c commit.c tree.c revwalk.c reference.c reference_iterator.c tag.c revparse.c,$ac_extra,shared_objects_git2,yes)
